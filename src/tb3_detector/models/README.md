...
Place YOLO26 weight files here.
...
Rebuild (`colcon build --symlink-install --packages-select tb3_detector`) after downloading so
...
- `yolo26s.pt`           — official small weights (COCO-80), optional upgrade
