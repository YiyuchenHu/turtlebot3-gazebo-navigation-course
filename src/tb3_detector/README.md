...
- **Config:** [`config/detector.yaml`](config/detector.yaml) (`conf_threshold`, `class_filter` — detector labels, never semantic names). Weights `yolo26n.pt` go in `models/`; see README → Installation
